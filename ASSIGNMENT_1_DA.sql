...
-- 3. List all the Customer information from Databse.
...
-- 7. Display all the films whose rental duration greater than 5.
...
select count(*) as total_no_of_film from film where replacement_cost <20;
...
-- 17. Find all the customer whose first name have "r" in the second position.
